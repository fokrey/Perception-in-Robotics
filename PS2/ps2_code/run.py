...
def main():
    ...
    # Assuming args.alphas is a list of strings from the command line
    # Convert each element to a float before squaring
    ...
    if write_movie:
        ...
        movie_writer = PillowWriter(fps=movie_fps, metadata=metadata)
